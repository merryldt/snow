...
public class ShiroUtil {
    ...
    private static Session getSessionByUsername(String username){
        ...
        for(Session session : sessions){
            ...
            user = (UserAdmin) ((SimplePrincipalCollection) attribute).getPrimaryPrincipal();
            if (user == null) {
                continue;
            }
    ...
    public static void kickOutUser(String username, boolean isRemoveSession){
        ...
        UserAdmin user = (UserAdmin) ((SimplePrincipalCollection) attribute).getPrimaryPrincipal();
